...
function prepare() {
    ...
    vec3.set(scaleVec, 0.1,0.2,0.3);

    var translateMatrix = mat4.create();
    mat4.identity(translateMatrix);
    mat4.scale(translateMatrix, translateMatrix, scaleVec);
...
function render() {
    ...
    mat4.multiply(transform, transform, rotMatrix);
    mat4.multiply(transform, transform, scaleMatrix);

    let uniformLoc = gl.getUniformLocation(program, "transform");
    gl.uniformMatrix4fv(uniformLoc, false, transform);
